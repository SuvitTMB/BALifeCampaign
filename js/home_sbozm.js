...
function CheckData() {
  ...
  .get().then((snapshot)=> {
    snapshot.forEach(doc=> {
      ...
      str += '<div class="field-container"><label for="expirationdate"><b>% CL</b> '+sessionStorage.getItem("ReportQ")+'</label>';
      str += '<input type="text" value="'+doc.data().AchCL+'" readonly></div>';
      str += '<div class="field-container"><label for="securitycode"><b>Reward</b> '+sessionStorage.getItem("ReportQ")+'</label>';
      str += '<input type="text" value="'+addCommas(doc.data().RewardCL.toFixed(0))+' บาท" readonly></div>';

      str += '<div class="field-container"><label for="expirationdate"><b>Target CL</b> '+sessionStorage.getItem("ReportQ")+'</label>';
      str += '<input type="text" value="'+addCommas(doc.data().TargetCL.toFixed(0))+' บาท" readonly></div>';
      str += '<div class="field-container"><label for="securitycode"><b>CL API</b> '+sessionStorage.getItem("ReportQ")+'</label>';
      str += '<input type="text" value="'+addCommas(doc.data().APICL.toFixed(0))+' บาท" readonly></div>';

      var str1 = "";
      str1 += '<div class="form-container" style="margin-top:-40px;">';
      str1 += '<div class="field-container"><label for="expirationdate"><b>Point CL</b> '+sessionStorage.getItem("ReportMonth")+'</label>';
      str1 += '<input type="text" value="'+addCommas(doc.data().PointCL.toFixed(0))+' คะแนน" readonly></div>';
      str1 += '</div>';

      var str2 = "";
      str2+= '<div class="clr"><div class="form-container"><div class="field-container" style="margin-top:-15px;border-top: 2px dashed #8c8b8b;height:10px;"></div></div></div>';


      var str3 = "";
      str3 += '<div class="form-container" style="margin-top:-50px;"><div class="field-container" style="display: none;">';
      str3 += '<label for="expirationdate"><b>APE Net</b> '+sessionStorage.getItem("ReportMonth")+'</label>';
      str3 += '<input type="text" value="12,000 บาท" readonly></div><div class="field-container" style="display: none;">';
      str3 += '<label for="expirationdate"><b>คะแนนสะสม</b> '+sessionStorage.getItem("ReportMonth")+'</label>';
      str3 += '<input type="text" value="12,000 บาท" readonly></div>';
      str3 += '<div class="field-container"><label for="securitycode"><b>OL API</b></label>';
      str3 += '<input type="text" value="'+addCommas(doc.data().OLAPI.toFixed(0))+' บาท" readonly></div>';
      str3 += '<div class="field-container"><label for="expirationdate"><b>OL Point</b></label>';
      str3 += '<input type="text" value="'+addCommas(doc.data().OLPoint.toFixed(0))+' คะแนน" readonly></div>';
      str3 += '</div>';


      var str4 = "";
      str4 += '<div class="form-container" style="margin-top:-40px;">';
      str4 += '<div class="field-container"><label for="securitycode"><b>OL Reward</b></label>';
      str4 += '<input type="text" value="'+addCommas(doc.data().OLReward.toFixed(0))+' บาท" readonly></div>';
      str4 += '</div>';
      str4+= '<div class="clr"><div class="form-container"><div class="field-container" style="margin-top:-15px;border-top: 2px dashed #8c8b8b;height:10px;"></div></div></div>';


      var str5 = "";
      str5 += '<div class="form-container" style="margin-top:-50px;">';
      str5 += '<div class="field-container"><label for="expirationdate"><b>Total Point All</b></label>';
      str5 += '<input id="expirationdate" type="text" value="'+addCommas(doc.data().Point_all.toFixed(0))+' คะแนน" readonly></div>';
      str5 += '</div>';
...
*/
      str += '</div>';
      $("#MyData1").html(str+str1+str2+str3+str4+str5);  
