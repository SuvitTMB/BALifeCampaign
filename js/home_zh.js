...
function CheckData() {
  ...
  .get().then((snapshot)=> {
    snapshot.forEach(doc=> {
      ...
      var str2 = "";
      var str3 = "";
      str2 += '<div class="form-container" style="margin-top:-20px;"><div class="field-container" style="display: none;">';
      str2 += '<label for="expirationdate"><b>APE Net</b> '+sessionStorage.getItem("ReportMonth")+'</label>';
      str2 += '<input type="text" value="12,000 บาท" readonly></div><div class="field-container" style="display: none;">';
      str2 += '<label for="expirationdate"><b>คะแนนสะสม</b> '+sessionStorage.getItem("ReportMonth")+'</label>';
      ...
      str2 += '<input type="text" value="'+addCommas(doc.data().TargetBATrip.toFixed(0))+' บาท" readonly></div>';
      str2 += '<div class="field-container"><label for="expirationdate"><b>APE Net - BA Trip</b></label>';
      str2 += '<input id="expirationdate" type="text" value="'+addCommas(doc.data().TotalAPENet.toFixed(0))+' บาท" readonly></div>';
      str2 += '</div>';
      str3 += '<div class="form-container" style="margin-top:-40px;">';
      str3 += '<div class="field-container"><label for="expirationdate"><b>Seat For Seller</b></label>';
      str3 += '<input id="expirationdate" type="text" value="'+addCommas(doc.data().SeatForSeller.toFixed(0))+' ที่นั่ง" readonly></div>';
      str3 += '</div>';
